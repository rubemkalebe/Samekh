...
%token <iValue> DECIMAL REAL HEX OCTAL CH
%token TRUE FALSE
...
declaration: declaration_specifiers declaration2
	;

declaration2: init_declarator_list SEMICOLON
	| SEMICOLON
	;


declaration_specifiers: storage_specifier declaration_specifiers
	| type_specifier
...
procedure_definition:
	PROC {printf("p21");} declarator {printf("p22");} compound_statement {printf("p23");} ENDPROC {printf("proc1\n");}
	;

function_definition:  FUNC {printf("f2\n");} direct_declarator {printf("f3\n");} compound_statement ENDFUNC {printf("func1\n");}
	;
...
union_specifier: UNION IDENTIFIER union_definition
	;

union_definition: LPAREN parameter_declaration RPAREN union_body ENDSTRUCT
	|
	;
