...
#line 320 "parser.cpp" /* yacc.c:355  */
};
...
#line 335 "parser.cpp" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "COMMA", "CONTINUE", "CONST", "DECIMAL", "DO", "DOT", "DOUBLE", "ENUM",
  "ELSE", "ELSIF", "END_CASE", "END_ENUM", "END_FOR", "END_FUNCTION",
  "END_IF", "END_PROCEDURE", "END_STRUCT", "END_UNION", "END_WHILE",
  "FALSE", "FLOAT", "FOR", "FUNCTION", "FLOATING_POINT", "HEX", "IF",
  "INT", "L_PAREN", "L_SQ_PAREN", "L_BRACE", "L_SHIFT", "LOG_NOT",
  "LOG_AND", "LOG_OR", "LOG_SC_AND", "LOG_SC_OR", "LONG", "NNULL", "OP_EQ",
  "OP_NE", "OP_PTR", "OP_PLUS", "OP_MINUS", "OP_ASTERISK", "OP_DIV",
  "OP_MOD", "OP_LET", "OP_LT", "OP_GET", "OP_GT", "OCTAL", "PRINT",
  "PRINTLN", "PROCEDURE", "READ", "RETURN", "R_PAREN", "R_SQ_PAREN",
  "R_BRACE", "R_SHIFT", "SHORT", "STRING", "STRING_LITERAL", "STRUCT",
  "STATIC", "SIZEOF", "SEMICOLON", "TRUE", "TYPEOF", "UNION", "WHEN",
  "WHILE", "$accept", "program", YY_NULLPTR
};
#endif
